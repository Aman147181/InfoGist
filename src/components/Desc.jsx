...
const Desc = () => {
  return (
    <div>
      <h1 className=' text-5xl font-extrabold leading-[1.15] text-black dark:text-gray-100 sm:text-6xl text-center pt-24 pb-8 '>
      ...
      <h2 className='text-lg text-gray-600 dark:text-gray-200 sm:text-xl text-center max-w-2xl mx-auto'>
